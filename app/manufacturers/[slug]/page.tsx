...
const MANUFACTURER_DESCRIPTIONS: Record<string, string> = {
  ...
  'Siemens': 'Siemens is a global leader in electrical power distribution. Their circuit breaker lines include the RL, WL, and Sentron series for low voltage applications, along with medium voltage vacuum breakers and a comprehensive range of switchgear, motor controls, and protective relays. Voyten Electric acquired the complete remaining inventory of Siemens Type RL and LA low voltage power circuit breakers from the Siemens Wendell, NC facility — making Voyten your New Surplus authorized source for RL breakers, Static Trip III units, and all associated accessories and renewal parts. Siemens continues to support legacy ITE and Gould product lines.',
