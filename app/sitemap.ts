...
async function generateStaticAndFilterSitemap(): Promise<MetadataRoute.Sitemap> {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${baseUrl}/resources/rl-breakers`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/resources/rl-breakers-lifecycle`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.85,
    },
    {
      url: `${baseUrl}/resources/spb-breakers-lifecycle`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.85,
    },
    ...
    ...['rl', 'wavepro', 'rd', 'mds-sbs', 'mw-iec', 'pxr-pdsb'].map((slug) => ({
