...
for (const amps of MISSING_RL_AMPS) {
  RL_ENTRIES.push({
    ...
    title: `Siemens Type RL ${amps}A Insulated Case Circuit Breaker Manual`,
    manual_number: 'SGIM-3068D',
    category: 'Circuit Breakers',
    manufacturer: 'Siemens',
    subcategory: 'Insulated Case Breakers',
...
for (const amps of RLE_AMPS) {
  RL_ENTRIES.push({
    ...
    title: `Siemens Type RLE ${amps}A Economical Insulated Case Circuit Breaker Manual`,
    manual_number: 'SGIM-3068D',
    category: 'Circuit Breakers',
    manufacturer: 'Siemens',
    subcategory: 'Insulated Case Breakers',
